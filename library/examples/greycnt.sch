...
C {devices/lab_pin} 570 -450 0 0 {name=p3 lab=A[4] } 
...
C {devices/lab_pin} 1230 -470 0 1 {name=p21 lab=C[4]} 
C {devices/lab_pin} 1230 -390 0 1 {name=p22 lab=C[3]} 
C {devices/lab_pin} 1230 -310 0 1 {name=p23 lab=C[2]} 
