...
C {capa} 550 -800 0 0 {name=c5 m=1 value="100n ic=0"}
C {lab_pin} 550 -290 0 0 {name=p11 lab=VSS}
C {capa} 550 -340 0 0 {name=c6 m=1 value="100n ic=0"}
...
C {capa} 170 -220 1 0 {name=c4 m=1 value="100n ic=0"}
C {lab_pin} 140 -220 0 0 {name=p0 lab=IN}
C {capa} 150 -680 1 0 {name=c1 m=1 value="100n ic=0"}
