...
C {code} 320 -210 0 0 {name=STIMULI value="
...
C {lab_pin} 640 -200 0 0 {name=p10 lab=VSS}
C {lab_pin} 640 -400 0 0 {name=p1 lab=VCC}
C {lab_pin} 960 -300 0 1 {name=p2 lab=Q}
C {lab_pin} 520 -340 0 0 {name=p3 lab=P}
C {res} 900 -250 0 0 {name=r1 m=1 value=10k}
C {capa} 820 -250 0 0 {name=c1 m=1 value=1n}
C {lab_pin} 820 -220 0 0 {name=p5 lab=VSS}
C {lab_pin} 900 -220 0 0 {name=p6 lab=VSS}
