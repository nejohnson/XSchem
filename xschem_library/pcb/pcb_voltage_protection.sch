...
C {conn_3x1} 150 -360 0 0 {name=C1}
C {vdd} 770 -490 0 0 {name=l6 lab=VCC}
C {lab_pin} 860 -300 0 1 {name=p0 lab=VOUT}
C {lab_wire} 660 -360 0 0 {name=l9 lab=G}
C {res} 770 -190 0 0 {name=Rload m=1 value=100 footprint=1206 device=resistor
tedax_ignore=true}
C {gnd} 770 -130 0 0 {name=l10 lab=VSS}
...
C {zener} 330 -190 2 0 {name=x3 model=BZX5V1 device=BZX5V1 area=1 footprint=acy(300)}
C {gnd} 330 -130 0 0 {name=l13 lab=VSS}
C {res} 330 -460 0 0 {name=R4 m=1 value=4.7K footprint=1206 device=resistor}
C {vdd} 330 -490 0 0 {name=l14 lab=VCC}
C {vdd} 600 -490 0 0 {name=l15 lab=VCC}
C {res} 600 -190 0 0 {name=R5 m=1 value=470 footprint=1206 device=resistor}
C {gnd} 600 -130 0 0 {name=l16 lab=VSS}
C {lab_wire} 360 -390 0 0 {name=l0 lab=B}
C {res} 330 -340 0 0 {name=R2 m=1 value=510 footprint=1206 device=resistor}
...
C {led} 650 -290 0 0 {name=x1 model=D1N5765 device=D1N5765 area=1 footprint=acy(300)}
C {title} 160 -30 0 0 {name=l2 author="Igor2"}
C {lab_pin} 170 -340 0 1 {name=p6 lab=VOUT}
C {lab_pin} 170 -360 0 1 {name=p7 lab=VSS}
C {lab_pin} 170 -380 0 1 {name=p8 lab=VCC}
C {zener} 250 -190 2 0 {name=x4 model=BZX5V1 device=BZX5V1 area=1 footprint=minimelf spice_ignore=true}
C {gnd} 250 -130 0 0 {name=l1 lab=VSS}
C {res} 550 -290 0 0 {name=R1 m=1 value=47K footprint=1206 device=resistor}
C {lab_wire} 330 -260 0 0 {name=l3 lab=Z}
